...
public class scene5_SystemTriangResolution implements Initializable {
    private Scene scene;
    private Stage stage;
    @FXML
    ...
    void calculer(ActionEvent event) throws IOException {
        ...
        switch (selectedOperation) {
            case "trianguliare inferieur":
            resultvector = resolution.resoudreTriangulaireInferieure(matrix1, vector);
                break;

            case "triangulaire superieur":
            resultvector = resolution.resoudreTriangulaireSuperieure(matrix1, vector);
                break;
                
            case "Triangulaire Inferieure Demi Bande":
            resultvector = resolution.resoudreTriangulaireInferieureDemiBande(matrix1, vector);
                break;

            case "Triangulaire Superieure Demi Bande":
            resultvector = resolution.resoudreTriangulaireSuperieureDemiBande(matrix1, vector);
                break;  
        } 
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        choice.getItems().addAll("trianguliare inferieur","triangulaire superieur","Triangulaire Inferieure Demi Bande","Triangulaire Superieure Demi Bande");    }
